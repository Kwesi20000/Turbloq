    ...
    <div className='py-5 px-5 md:px-12 lg:px-28'>
      ...
      <div className='text-center my-8'>
        ...
        <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>
          Welcome to Turblog! Here, you will find insightful articles on a variety of topics including technology, startups, lifestyle, and more. Our goal is to keep you informed and inspired with the latest trends and tips. Stay tuned for fresh content every week!
        </p>
